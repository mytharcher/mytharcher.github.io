...
文章本来在去年末就开始整理，大致的内容也在 [Yncoder 云南开发者社区](https://yncoder.org) 的年末聚会活动上简单分享了一些，但诸多事情只好趁过年稍微空闲一些才最终成文。另外由于比较长，没时间细读的可以直接拉到最后：[太长不看版](#太长不看版)。
...
0. 早制定各类规范、框架，撰写文档，不只是技术方面，还有团队管理和公司规章制度（但都要可执行）。
